          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {sectors.map((sector) => (
              <Link
                key={sector.href}
                href={sector.href}
                className="group bg-white p-7 rounded-xl border border-gray-200 hover:border-gold/30 hover:shadow-card-hover transition-all duration-300 flex items-center justify-between"
              >
